...
var _reactNativeBackgroundTimer = require('react-native-background-timer');
...
function createPersistor(store, config) {
  ...
  store.subscribe(function () {
    ...
    if (timeIterator === null) {
      timeIterator = _reactNativeBackgroundTimer2.default.setInterval(function () {
        console.log(">>>PERSISTING");
        if (paused && len === storesToProcess.length || storesToProcess.length === 0) {
          _reactNativeBackgroundTimer2.default.clearInterval(timeIterator);
          timeIterator = null;
          return;
        }
